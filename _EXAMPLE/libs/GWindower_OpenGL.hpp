...
#pragma region _GLAD_H
/*

    OpenGL loader generated by glad 0.1.36 on Sat Jul 18 16:37:15 2026.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_texture_filter_anisotropic"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.6&extensions=GL_ARB_texture_filter_anisotropic
*/
...
class GWindower_OpenGL { public: ~GWindower_OpenGL();
        int screen_width, screen_height;
        GWindower_OpenGL(int window_width = 0, int window_height = 0);  // leave width and height at 0 for fullscreen
